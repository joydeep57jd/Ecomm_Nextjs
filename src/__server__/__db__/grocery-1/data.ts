...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      ...
      { icon: "Milk", title: "Dairy & Eggs", href: "/grocery-1/dairy-and-eggs" },
      ...
      { icon: "Yogurt", title: "Frozen", href: "/grocery-1/frozen" },
      {
        ...
        title: "Vegetables",
        child: [
          { title: "Pears, apples, quinces", href: "/grocery-1/pears-apples-quinces" },
          { title: "Peaches, plums, apricots", href: "/grocery-1/peaches-plums-apricots" },
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "Snack", title: "Coffee & Snacks", href: "/grocery-1/coffee-and-snacks" },
      { icon: "Bottle", title: "Sauces & Jams", href: "/grocery-1/sauces-and-jams" }
    ]
  }
]
