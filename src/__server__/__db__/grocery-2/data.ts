    ...
    child: [
      ...
      },
      {
        ...
        child: [
          ...
          { title: "Vegetable Pack", href: "/products/search?category=clothes" }
        ]
      }
    ]
  },
  { icon: "Milk", title: "Dairy & Eggs", href: "/products/search?category=clothes" },
  { icon: "Breakfast", title: "Breakfast", href: "/products/search?category=clothes" },
  { icon: "Yogurt", title: "Frozen", href: "/products/search?category=clothes" },
  { icon: "Honey", title: "Organic", href: "/products/search?category=clothes" },
  { icon: "Beer", title: "Canned Food", href: "/products/search?category=clothes" },
  { icon: "Snack", title: "Coffee & Snacks", href: "/products/search?category=clothes" },
  { icon: "Bottle", title: "Sauces & Jams", href: "/products/search?category=clothes" },
  { icon: "Honey", title: "Organic", href: "/products/search?category=clothes" },
  { icon: "Beer", title: "Canned Food", href: "/products/search?category=clothes" },
  { icon: "Snack", title: "Coffee & Snacks", href: "/products/search?category=clothes" },
  { icon: "Bottle", title: "Sauces & Jams", href: "/products/search?category=clothes" }
